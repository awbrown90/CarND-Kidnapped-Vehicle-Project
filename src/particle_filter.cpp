...
void ParticleFilter::init(double x, double y, double theta, double std[]) {
	...
	for (int i = 0; i < num_particles; i++)
	{
		...
		//cout << "startx: " << particle.x << endl;
		//cout << "starty: " << particle.y << endl;
		//cout << "startt: " << particle.theta << endl;
...
void ParticleFilter::prediction(double delta_t, double std_pos[], double velocity, double yaw_rate) {
	// TODO: Add measurements to each particle and add random Gaussian noise for velocity and yaw rate uncertainty.
